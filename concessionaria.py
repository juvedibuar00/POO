...
class Carro(Veiculo):
    ...
    def exibirInformacoes(self):
        print((f'O carro da {self. marca}, ano {self.anoFabricacao}, modelo {self.modelo}, {self.nPortas}, {self.tipoCombustivel}, custa {self.preco}'))
#moto
class Moto(Veiculo):
...
moto1 = Moto('Honda', 'PCX - 152', 2024, 16400, 125, 'eletrica')
